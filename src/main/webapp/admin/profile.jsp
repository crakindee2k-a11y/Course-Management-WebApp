...
<head>
    ...
    <title>Admin Profile - Course Management System</title>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col">
                <h2><i class="bi bi-person-circle me-2"></i>Admin Profile</h2>
                    ...
                    <div class="card-body">
                        <form method="post" action="${pageContext.request.contextPath}/profile">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Admin usernames cannot be changed</div>
                            </div>
